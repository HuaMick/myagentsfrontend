...
void main() {
  ...
  assert(decrypted1 == message1, 'Dart self-decryption failed for test 1');
  print('Dart self-decryption: OK');
  print('');
  ...
  assert(decrypted2 == message2, 'Dart self-decryption failed for test 2');
  print('Dart self-decryption: OK');
  print('');
  ...
  assert(decrypted3 == message3, 'Dart self-decryption failed for test 3');
  print('Dart self-decryption: OK');
  print('');
